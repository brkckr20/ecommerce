      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        <div>
          ...
          <textarea
            ...
            rows={4}
            placeholder="#F5D6D6"
            className="w-full rounded-lg border border-[#EEEEEE] px-3 py-2 text-sm outline-none focus:border-[#DA3F3F]"
          />
                    ...
                    return (
                      <td key={key} className="border border-[#EEEEEE] px-2 py-1.5">
                        <input
                          ...
                          className="w-full rounded border border-[#EEEEEE] px-2 py-1 text-center text-xs outline-none focus:border-[#DA3F3F]"
                        />
                      </td>
                    );
                  })}
